...
describe("Sepolia Logic Test on Arbitrum Fork", function () {
  this.timeout(200_000);
  
  // Arbitrum addresses (since we're forking Arbitrum)
  const ARBITRUM_USDC_ADDRESS = "0xaf88d065e77c8cc2239327c5edb3a432268e5831";
  const ARBITRUM_WETH_ADDRESS = "0x82aF49447D8a07e3bd95BD0d56f35241523fBab1";
  
  // Uniswap V3 addresses (same on Arbitrum)
  ...
  async function deployContracts() {
    ...
    console.log("Forking Arbitrum:", network.config.forking?.url?.includes('arbitrum'));
    
    // Use real Arbitrum tokens (since we're forking Arbitrum)
    ...
    // Uniswap contracts (these exist on Arbitrum fork)
  ...
  describe("Sepolia Logic Test on Arbitrum Fork", function () {
    it("should test investIdle with Sepolia logic on Arbitrum fork", async () => {
      ...
      console.log("\n=== TESTING SEPOLIA LOGIC ON ARBITRUM FORK ===");
