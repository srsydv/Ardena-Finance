/*
  Add balanced liquidity to the existing pool with both WETH and USDC.
  
  This will add liquidity in the correct ratio to help rebalance the pool.
*/
...
async function main() {
    console.log("=== ADDING BALANCED LIQUIDITY TO EXISTING POOL ===");
    ...
    try {
        ...
        console.log("\n=== STEP 1: CHECKING CURRENT POOL STATE ===");
        ...
        console.log(`Current Pool ${token0Symbol} balance:`, ethers.formatUnits(poolToken0Balance, 18), token0Symbol);
        console.log(`Current Pool ${token1Symbol} balance:`, ethers.formatUnits(poolToken1Balance, 6), token1Symbol);
        ...
        // Add balanced liquidity: 10 WETH + 1000 USDC (1:100 ratio)
        const wethToAdd = ethers.parseEther("10"); // 10 WETH
        const usdcToAdd = ethers.parseUnits("1000", 6); // 1000 USDC
        
        if (deployerUSDCBalance < usdcToAdd || deployerWETHBalance < wethToAdd) {
            console.log("❌ Insufficient balance to add balanced liquidity");
            console.log("Need:", ethers.formatUnits(wethToAdd, 18), "WETH and", ethers.formatUnits(usdcToAdd, 6), "USDC");
            console.log("Have:", ethers.formatUnits(deployerWETHBalance, 18), "WETH and", ethers.formatUnits(deployerUSDCBalance, 6), "USDC");
            return;
        }
        
        console.log("✅ Sufficient balance for adding balanced liquidity");
        ...
        console.log("\n=== STEP 4: PREPARING BALANCED LIQUIDITY AMOUNTS ===");
        
        // Add balanced liquidity
        const amount0Desired = wethToAdd; // 10 WETH
        const amount1Desired = usdcToAdd; // 1000 USDC
        ...
        console.log("\n=== STEP 6: ADDING BALANCED LIQUIDITY ===");
        ...
        try {
            ...
            if (receipt.status === 1) {
                ...
                // Calculate new price
                const newSqrtPriceX96 = newSlot0[0];
                console.log("New sqrtPriceX96:", newSqrtPriceX96.toString());
                
                console.log("\n💡 Balanced liquidity added successfully!");
                console.log("Pool should now be more balanced for swaps");
    ...
    console.log("\n🎉 BALANCED LIQUIDITY ADDITION COMPLETED!");
}
