...
//     const mochERC20 = await ethers.getContractFactory("MockERC20");
...
//     async function encodePriceSqrtJS(reserve1, reserve0) {
//         const Q96 = (BigInt(1) << BigInt(96));
//         const ratio = (BigInt(reserve1) * Q96) / BigInt(reserve0);
//         function sqrt(value) {
...
//         params: [deployer.address, "0xde0b6b3a7640000"], // 1 ETH in hex (wei)
//       });
...
//       const reserve0 = BigInt("1000000"); // 1 USDC (6)
//       const sqrtPriceX96 = await encodePriceSqrtJS(reserve1, reserve0);

//       // create and initialize pool
//       await INonfungiblePositionManager.createAndInitializePoolIfNecessary(
//         WETH,
//         USDC_ADDRESS,
//         501,
...
//       poolAddress = await IUniswapV3Factory.getPool(WETH, USDC, FEE);
