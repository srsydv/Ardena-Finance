...
describe("Vault + UniswapV3 Strategy E2E", function () {
  ...
  async function deployContracts() {
    ...
    factory = await ethers.getContractAt(
      ...
      "0x1F98431c8aD98523631AE4a59f267346ea31F984" // UniswapV3Factory (same on Arbitrum)
    );
    positionManager = await ethers.getContractAt(
      INonfungiblePositionManagerABI,
      "0xC36442b4a4522E871399CD717aBDD847Ab11FE88" // NonfungiblePositionManager (same on Arbitrum)
    );
  ...
  describe("Deployment", function () {
    ...
    it("should create pool if not exists, deposit, invest, and harvest fees", async () => {
      ...
      // Encode exactInputSingle(params) for SwapRouter02
      const artifact = require("@uniswap/swap-router-contracts/artifacts/contracts/SwapRouter02.sol/SwapRouter02.json");
